...
public class LoadRrgisterHappyDataExcel2try {
	FileInputStream stream=null;
	public FileInputStream getExcelsheet() throws FileNotFoundException {
	String path =System.getProperty("user.dir")+"\\src\\test\\java\\data\\Excel\\RegisterData.xlsx";
		stream=new FileInputStream(path);
		return stream;
	}
	public Object[][]getExcelFileData() throws IOException{
		DataFormatter formatter = new DataFormatter();
		stream =getExcelsheet();
